...
class EmployeeController {
    ...
    ResponseEntity<EntityModel<Employee>> createNewEmployee(@RequestBody Employee newEmployee) {
    ...
    ResponseEntity<EntityModel<Employee>> replaceEmployee(@RequestBody Employee newEmployee, @PathVariable UUID id) {
    ...
    ResponseEntity<Employee> deleteEmployee(@PathVariable UUID id) {
