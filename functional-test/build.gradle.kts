...
dependencies {
    ...
    testFixturesApi(platform("com.squareup.okhttp3:okhttp-bom:5.0.0"))
    testFixturesApi("com.squareup.okhttp3:okhttp")
    testFixturesApi("com.google.guava:guava:33.4.8-jre")
    ...
    testFixturesImplementation("commons-io:commons-io:2.19.0")
